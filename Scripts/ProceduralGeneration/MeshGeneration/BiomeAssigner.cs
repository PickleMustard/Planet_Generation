...
public static class BiomeAssigner
{
    ...
    public static Biome.BiomeType AssignBiome(UnifiedCelestialMesh generator, float height, float moisture, float latitude = 0f)
    {
        ...
        else if (normalizedHeight < 0.05f) result = Biome.BiomeType.Ocean;
        else if (normalizedHeight < 0.07f) result = Biome.BiomeType.Coastal;
        else if (normalizedHeight < 0.3f && moisture < 0.2f) result = Biome.BiomeType.Desert;
        else if (normalizedHeight < 0.3f && moisture < 0.5f) result = Biome.BiomeType.Grassland;
