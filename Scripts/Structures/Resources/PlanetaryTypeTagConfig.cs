...
public class PlanetaryTypeTagConfig
{
    ...
    public SubtypeTagConfig? GetConfigForSubtype(CelestialBodyType bodyType, object? subtype)
    {
        if (subtype == null)
            return null;
    ...
    /// <summary>
    /// Gets the tag configuration for a satellite subtype.
    /// Satellites use a separate enum and are not part of CelestialBodyType.
    /// </summary>
    public SubtypeTagConfig? GetConfigForSatelliteSubtype(object? subtype)
    {
