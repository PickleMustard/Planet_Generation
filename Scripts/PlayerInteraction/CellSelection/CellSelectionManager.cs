...
namespace PlayerInteraction.CellSelection
{
    ...
    public partial class CellSelectionManager : Node
    {
        ...
        /// </summary>
        [Signal]
        public delegate void CellSelectedEventHandler(VoronoiCell cell, Node3D body);
        ...
        public void SelectCell(VoronoiCell cell, Node3D body)
        {
            ...
            EmitSignal(SignalName.CellSelected, cell, body);
        }
