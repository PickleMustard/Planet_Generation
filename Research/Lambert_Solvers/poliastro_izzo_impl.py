"""
Poliastro Izzo Lambert Solver Implementation
===========================================

This is the complete source code from poliastro's izzo.py implementation.
Source: https://github.com/poliastro/poliastro
File: src/poliastro/iod/izzo.py

This is the numba-jit加速 version that contains the actual algorithm.
"""
...
# ============================================================================
# Supporting functions from poliastro.core.iod (if separate file)
# ============================================================================

@jit
def vallado(k, r0, r, tof, M, prograde, lowpath, numiter, rtol):
    r"""Solves the Lambert's problem using Vallado's algorithm.
