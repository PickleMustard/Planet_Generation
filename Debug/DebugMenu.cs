...
using Debug.Console;
using Debug.Economy;
using Debug.ManufactureTick;
using CellInfoModule = Debug.CellInfo.CellInfo;
using DatabaseViewerModule = Debug.DatabaseViewer.DatabaseViewer;
...
#if DEBUG
        var economyScene = GD.Load<PackedScene>("res://Debug/Economy/EconomyDebugModule.tscn");
